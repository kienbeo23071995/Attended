...
namespace Group01_PRJ.Controllers
{
    public class SlotsController : Controller
    {
        ...
        public SlotsController(AttendedContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] Slot slot)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] Slot slot)
        {
            if (id != slot.Id)
            {
                return NotFound();
